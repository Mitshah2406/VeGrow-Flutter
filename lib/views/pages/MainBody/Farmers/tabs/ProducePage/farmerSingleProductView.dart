...
class FarmerSingleProductPage extends StatefulWidget {
   FarmerSingleProductPage({super.key});
  final _formKey = GlobalKey<FormState>();
  final TextEditingController bidController = new TextEditingController();
  
  final ProductController productController = Get.find();
  @override
  State<FarmerSingleProductPage> createState() => _FarmerSingleProductPageState();
}

class _FarmerSingleProductPageState extends State<FarmerSingleProductPage> {
